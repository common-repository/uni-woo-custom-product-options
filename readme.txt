...
* Non-option variables (NOV) - Synthetic variables that can hold either a specific value or a mathematical formula as their value. [Docs >>](https://kb.moomoo.agency/uni-cpo-4-documentation/usage/panel/nov)
* Table pricing functionality - Import prices from a CSV file. [Docs >>](https://kb.moomoo.agency/uni-cpo-4-documentation/usage/panel/nov#nov-with-matrix-functionality-pro)
...
* Formula conditional logic - Apply different mathematical formulas based on the values of custom options! [Docs >>](https://kb.moomoo.agency/uni-cpo-4-documentation/usage/panel/fcl)
* Fields conditional logic - Display or hide certain custom options based on the values of other custom options and/or NOVs. [Docs >>](https://kb.moomoo.agency/uni-cpo-4-documentation/usage/fields-conditional-logic)
* Validation for value of product custom options [Docs >>](https://kb.moomoo.agency/uni-cpo-4-documentation/usage/validation-conditional-logic)
* Dynamic calculation of weight and dimensions based on product options' values! [Docs >>](https://kb.moomoo.agency/uni-cpo-4-documentation/usage/panel/wcl)
* Apply different shipping classes based on the chosen product options! [Docs >>](https://kb.moomoo.agency/uni-cpo-4-documentation/usage/panel/shipping-classes-logic)
* Cart discounts! [Docs >>](https://kb.moomoo.agency/uni-cpo-4-documentation/usage/panel/cart-discounts)
* Dynamic SKU generation and stock management for products with custom options. Import/export stock data using a CSV file. [Via paid add-on for Uni CPO!](https://kb.moomoo.agency/uni-cpo-4-documentation/uni-cpo-add-ons/dynamic-sku-for-woocommerce)
